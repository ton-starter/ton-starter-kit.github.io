  ...
  <div id="error">
    ...
    <div v-if="error?.statusCode === 404" class="err_info">
      <div class="err_message">
        ...
        существует. Она могла устареть или была удалена. Возможно, в адресной
        строке браузера введен неверный адрес.
      </div>
    ...
    <div v-else-if="error?.statusCode === 500" class="err_info">
      <div class="err_message">
        ...
        Кажется, что-то пошло не так. Cервер не может обработать запрос к сайту,
        на странице которого вы находитесь.
      </div>
      <!-- <img class="err_img" src="/img/error/500.png" alt="" /> -->
      <NuxtLink to="/">Начните с главной</NuxtLink>
    </div>
    <div v-else class="err_info">
      <h1>Ошибка</h1>
